...
class MonologHandler extends \Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct(\Faultline\Notifier $notifier, $level = Logger::ERROR, $bubble = true)
    {
    ...
    protected function write(array $record)
    {
        ...
        $exc = new \Airbrake\Errors\Base($record['message'], $trace);
